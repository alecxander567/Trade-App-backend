...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to create notification", details: err.message });
  }
});
...
router.get("/:userId", async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to fetch notifications", details: err.message });
  }
});
...
router.put("/:id/accept", async (req, res) => {
  ...
  try {
    ...
    const receiver = await User.findById(notification.recipient);
    ...
    res
      .status(500)
      .json({ error: "Failed to accept trader request", details: err.message });
  }
});
